<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RechargeTransactionReport.aspx.cs" Inherits="InternalApp.admin.Reports.RechargeTransactionReport" %>
...
<head runat="server">
    <title>Recharge Transaction Report</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h1 class="card-title" style="color: #d9880f; font-size: x-large">Recharge Transaction Report</h1>
                                </div>
                                <div class="card-header">
                                ...
                                <div class="card-body">
                                    ...
                                    <asp:Panel ID="pnl" runat="server" ScrollBars="Both" Height="500px">
                                        ...
                                        <asp:GridView ID="grd_recharge_transaction_report" runat="server" class="table" HeaderStyle-CssClass="k-header" GridLines="Both" HeaderStyle-BackColor="#d9880f" BorderColor="#d9880f"
                                            ShowHeaderWhenEmpty="true" HeaderStyle-ForeColor="White" AutoGenerateColumns="true" AllowPaging="true" OnPageIndexChanging="grd_recharge_transaction_report_PageIndexChanging" PageSize="10">
