<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pg_topup_report.aspx.cs" Inherits="InternalApp.admin.reports.pg_topup_report" %>
...
<script type="text/javascript">
    ...
    <script type = "text/javascript" >
        history.pushState(null, null, 'jkjjhger34bhjjg55ffg');
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h1 class="card-title" style="color:#d9880f;font-size:x-large">PG Topup Report</h1>
                  </div>
              <div class="card-header">
 ...
 <div class="form-group">
              ...
              <div class="card-body">
                   ...
                   <asp:Panel ID="pnl" runat="server" ScrollBars="Both" Height="500px">
                                            ...
                                            <asp:GridView ID="grd_pg_topup_report" runat="server" class="table" HeaderStyle-CssClass="k-header" GridLines="Both" HeaderStyle-BackColor="#d9880f" BorderColor="#d9880f"
