...
{
    public partial class dmt_transaction_report : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            try
            {
                ...
                grd_transaction_report.DataSource = ds.Transaction_rpt(Convert.ToDateTime(FDate.Text), Convert.ToDateTime(ToDate.Text), DDL_Search.SelectedValue, txt_searchvalue.Text);
        ...
        protected void btn_excel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (FDate.Text != "" & ToDate.Text != "")
                {
                    ...
                    grdiew.DataSource = ds.Transaction_rpt(Convert.ToDateTime(FDate.Text), Convert.ToDateTime(ToDate.Text), DDL_Search.SelectedValue, txt_searchvalue.Text);
                    grdiew.DataBind();
                    Response.ClearContent();
                    Response.Buffer = true;
                    Response.AddHeader("Content-disposition", string.Format("attachement; filename={0}", "TransactionReport.xls"));
