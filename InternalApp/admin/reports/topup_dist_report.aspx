<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="topup_dist_report.aspx.cs" Inherits="InternalApp.admin.reports.topup_dist_report" %>
...
<script type="text/javascript">
    ...
    <script type = "text/javascript" >
        history.pushState(null, null, 'nh54fdfgfbyuy7mjgxk');
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h1 class="card-title" style="color:#d9880f;font-size:x-large">Working Capital Topup Report</h1>
                  </div>
              <div class="card-header">
 ...
 <div class="form-group">
              ...
              <div class="card-body">
                   ...
                   <asp:Panel ID="pnl" runat="server" ScrollBars="Both" Height="500px">
                                            ...
                                            <asp:GridView ID="grd_topup_dist_report" runat="server" class="table" HeaderStyle-CssClass="k-header" GridLines="Both" HeaderStyle-BackColor="#d9880f" BorderColor="#d9880f"
