<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dmt_transaction_report.aspx.cs" Inherits="InternalApp.admin.reports.dmt_transaction_report" %>
...
<script type="text/javascript">
    ...
    <script type = "text/javascript" >
        history.pushState(null, null, 'hgfr555ggfggh65gghh');
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h1 class="card-title" style="color:#d9880f;font-size:x-large">DMT Transaction Report</h1>
                  </div>
              <div class="card-header">
