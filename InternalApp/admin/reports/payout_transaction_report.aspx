<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payout_transaction_report.aspx.cs" Inherits="InternalApp.admin.reports.payout_transaction_report" %>
...
<head runat="server">
 <title>Payout Transaction Report</title>
...
<script type="text/javascript">
    ...
    <script type = "text/javascript" >
        history.pushState(null, null, 'bgvgf444fdfdytfdsx');
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h1 class="card-title" style="color:#d9880f;font-size:x-large">Payout Transaction Report</h1>
                  </div>
              <div class="card-header">
 ...
 <div class="form-group">
                        ...
                        <div class="form-group">
                             <label>Search Option</label>
                                                                ...
                                                                <asp:DropDownList runat="server" ID="DDL_Search" class="form-control">
                                                                    ...
                                                                    <asp:ListItem Value="2" Text="SenderMobileno"></asp:ListItem>
                                                                    <asp:ListItem Value="3" Text="RetailerMobileNo"></asp:ListItem>
                                                                    <asp:ListItem Value="4" Text="DistMobileNo"></asp:ListItem>
              ...
              <div class="card-body">
                   ...
                   <asp:Panel ID="pnl" runat="server" ScrollBars="Both" Height="500px">
                                            ...
                                            <asp:GridView ID="grd_payout_transaction_report" runat="server" class="table" HeaderStyle-CssClass="k-header" GridLines="Both" HeaderStyle-BackColor="#d9880f" BorderColor="#d9880f"
                                                ShowHeaderWhenEmpty="true" HeaderStyle-ForeColor="White" AutoGenerateColumns="true" AllowPaging="true"  OnPageIndexChanging="grd_payout_transaction_report_PageIndexChanging" PageSize="10">                                                
