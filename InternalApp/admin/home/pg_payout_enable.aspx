<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pg_payout_enable.aspx.cs" Inherits="InternalApp.admin.home.pg_payout_enable" %>
...
<script type="text/javascript">
    ...
    <script type = "text/javascript" >
        history.pushState(null, null, 'asjghghghgh655443tgokhf');
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h1 class="card-title" style="color: #d9880f; font-size: x-large">PG/Payout Activation</h1>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="tab-pane" id="settings">
                                <div class="form-horizontal">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <asp:TextBox runat="server" class="form-control" ID="txt_mobile_no" placeholder="Mobile No" onkeypress="if(event.keyCode<48 || event.keyCode>57)event.returnValue=false;" OnTextChanged="txt_mobile_no_TextChanged" AutoPostBack="true" MaxLength="10" ></asp:TextBox>
                                        </div>
                                    </div>
                                    

                                    <div class="form-group row">
                                        <label for="inputName" class="col-sm-2 control-label">PG Status *</label>
                                        <div class="col-sm-4">
                                            <asp:DropDownList runat="server" CssClass="form-control" ID="ddl_pg_status">
                                                 <asp:ListItem Value="0" Text="Select PG Status"></asp:ListItem>
                                                <asp:ListItem Value="1" Text="Enable"></asp:ListItem>
                                                 <asp:ListItem Value="2" Text="Disable"></asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    
                                    <div class="form-group row">
                                        <label for="inputName" class="col-sm-2 control-label">Payout Status *</label>
                                        <div class="col-sm-4">
                                            <asp:DropDownList runat="server" CssClass="form-control" ID="ddl_payout_status">
                                                 <asp:ListItem Value="0" Text="Select Payout Status"></asp:ListItem>
                                                <asp:ListItem Value="1" Text="Enable"></asp:ListItem>
                                                 <asp:ListItem Value="2" Text="Disable"></asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
