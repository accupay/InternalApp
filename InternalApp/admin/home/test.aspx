<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test.aspx.cs" Inherits="InternalApp.admin.home.test" %>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-pane" id="settings">
                               <asp:GridView ID="GridView1" runat="server" CssClass="table table-striped table-hover" 
                                   DataKeyNames="student_Id" AutoGenerateColumns="false" GridLines="None" OnRowCommand="GridView1_RowCommand1">
                                    <Columns>
                ...
                <asp:TemplateField HeaderText="Pay">
                   <ItemTemplate>
                       <asp:LinkButton ID="lnkBtnEdit" runat="server" CommandArgument='<%# Eval("Student_Id")%>'
                                        CommandName="rowEdit" Text="Pay Now" CssClass="btn btn-info" ></asp:LinkButton>
                   </ItemTemplate>
               </asp:TemplateField>
           </Columns>
                                   </asp:GridView>      
