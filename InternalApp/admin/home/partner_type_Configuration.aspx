<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="partner_type_Configuration.aspx.cs" Inherits="InternalApp.admin.home.partner_type_Configuration" %>
...
<head runat="server">
    <title>Partner Type Config</title>
...
<script type="text/javascript">
    ...
    <script type = "text/javascript" >
        history.pushState(null, null, 'vbfgdfg45g65hgfgh0gg');
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h1 class="card-title" style="color: #d9880f; font-size: x-large">Partner Type Config</h1>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="tab-pane" id="settings">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group row">
                                        <label for="inputName" class="col-sm-2 control-label">Retailer Name </label>
                                        <div class="col-sm-4">
                                            <asp:TextBox runat="server" class="form-control" ReadOnly="true" ID="txt_merchant_name" placeholder="" ></asp:TextBox>
                                        </div>
                                    </div>
                                       <div class="form-group row">
                                        <label for="inputName" class="col-sm-2 control-label">Retailer Mobile Number</label>
                                        <div class="col-sm-4">
                                            <asp:TextBox runat="server" class="form-control" ReadOnly="true" ID="txt_ret_mob_no" placeholder="" ></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputName" class="col-sm-2 control-label">Partner Type Description</label>
                                        <div class="col-sm-4">
                                            <asp:TextBox runat="server" class="form-control" ReadOnly="true" ID="txt_partner_type" placeholder="" ></asp:TextBox>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="inputName" class="col-sm-2 control-label">Partner Type *</label>
                                        <div class="col-sm-4">
                                            <asp:DropDownList runat="server" CssClass="form-control" ID="ddl_partner_type">
                                                 <asp:ListItem Value="0" Text="Select Partner Type"></asp:ListItem>
                                                <asp:ListItem Value="1" Text="DMT"></asp:ListItem>
                                                 <asp:ListItem Value="2" Text="Payout"></asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    </div>
