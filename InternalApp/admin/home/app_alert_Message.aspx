<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="app_alert_Message.aspx.cs" Inherits="InternalApp.admin.home.app_alert_Message" %>
...
<script type="text/javascript">
    ...
    <script type = "text/javascript" >
        history.pushState(null, null, 'hjytyuwyfp102a3o25t');
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h1 class="card-title" style="color: #d9880f; font-size: x-large">App. Message Config.</h1>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="tab-pane" id="settings">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <asp:TextBox runat="server" class="form-control" ID="txt_msg" placeholder="" TextMode="MultiLine" MaxLength="500"></asp:TextBox>
                                        </div>
                                        <label id="lblmessage" for="inputName"  class="col-sm-2 control-label">(Maximum 500 Character's Only Allowed)</label>
                                    </div>
