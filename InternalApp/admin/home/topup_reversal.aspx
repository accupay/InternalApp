<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="topup_reversal.aspx.cs" Inherits="InternalApp.admin.home.topup_reversal" %>
...
<script type="text/javascript">
    ...
    <script type = "text/javascript" >
        history.pushState(null, null, 'kkhhghddfghg077hbhgf');
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h1 class="card-title" style="color: #d9880f; font-size: x-large">Topup Reversal</h1>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="tab-pane" id="settings">
                                <div class="form-horizontal">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <asp:TextBox runat="server" class="form-control" ID="txt_mobile_no" placeholder="Mobile No" AutoPostBack="true" onkeypress="if(event.keyCode<48 || event.keyCode>57)event.returnValue=false;" OnTextChanged="txt_mobile_no_TextChanged" MaxLength="10" ></asp:TextBox>
                                        </div>
                                    </div>
                                  <div class="form-group row">
                                        <label for="inputName" class="col-sm-2 control-label">Agency Name </label>
                                        <div class="col-sm-4">
                                            <asp:Label runat="server" class="form-control"  ID="lbl_agency_name" placeholder="Agency Name" ></asp:Label>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputName" class="col-sm-2 control-label">Transaction ID *</label>
                                        <div class="col-sm-4">
